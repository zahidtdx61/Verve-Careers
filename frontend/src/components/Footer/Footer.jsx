...
const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 mt-12 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="max-w-lg sm:mx-auto sm:text-center">
        <div className="text-4xl font-lexend text-black">Bloom Hire</div>
        <p className="leading-relaxed mt-2 text-[15px]">
          At Bloom Hire, we believe in creating opportunities that help
          individuals and businesses thrive. Whether you're searching for your
          dream job or looking for the perfect candidate, we’re here to make it
          happen. Let us be your trusted partner in building a brighter
          professional future.
        </p>
      </div>
      ...
      <div className="mt-8 items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; 2024 Bloom Hire All rights reserved.
        </div>
